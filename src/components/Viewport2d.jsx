...
class Viewport2d extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  onMouseWheel = delta => {
    ...
    const cnt = this.state.mouseOver
      ? this.state.mouseSpacePos
      : [v[0], v[1]];
...
Viewport2d.propTypes = {
  width: number.isRequired,
  height: number.isRequired,
  step: number,
  initialViewport: shape({}).isRequired,
  children: func.isRequired,
};

Viewport2d.defaultProps = {
  step: 1.1,
};
